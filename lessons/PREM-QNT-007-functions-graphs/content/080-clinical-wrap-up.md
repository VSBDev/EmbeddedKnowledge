...
The invented drug **Velunor**, its single-dose case, curve, and all numerical values below are author-created teaching material rather than real drug or patient data.
...
A fictional bedside team reviews the curve after one illustrative dose of Velunor. Read from Figure 1:
...
The negative sign means concentration is falling during this fictional case's elimination phase.
