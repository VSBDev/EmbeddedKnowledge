...
- Rival-explanation check: off-target effects remain possible, and the proposed rescue contrast must distinguish the named DNA-binding step from other Tide-1 functions.
