...
| C: randomized course study | Six hundred eligible students were randomly offered immediate app access or access after the final. The immediate-offer group averaged 77 and the delayed-offer group 74 on the same anonymously graded exam. An exam score was recorded for every assigned student. |
...
**Packet C.** Random assignment creates comparable offer groups in expectation, the offer precedes the exam, both groups take the same anonymously graded outcome, and follow-up is complete. The difference in means is $77 - 74 = 3$ points. An intention-to-treat comparison keeps students in their assigned offer groups whether or not each one used the app. Under the stated implementation and complete-follow-up conditions, the strongest conclusion is:

> The observed three-point difference estimates that offering immediate access raised the mean exam score compared with delayed access among eligible students in this course. Because no interval or other precision information is supplied, the size and even the direction of the underlying assignment effect remain uncertain.

That sentence treats the observed contrast as an estimate of the effect of the **offer**, not of actual use. It also stays within the studied course and conditions. Generalizing to other subjects, assessment types, access arrangements, or populations needs additional evidence.

**Independent checks.** The eight-point observational contrast is much larger than the three-point randomized-offer contrast. That does not prove the cohort was confounded, but it is consistent with positive self-selection into app use. Complete outcome recording in this fictional packet removes attrition as an explanation for the displayed contrast. If instead 7% of each group lacked scores, equal percentages alone would not prove missingness harmless: investigators would still need to examine why outcomes were missing and how the missing cases could change the estimate. A 30% versus 5% imbalance would make attrition an especially visible rival explanation.
