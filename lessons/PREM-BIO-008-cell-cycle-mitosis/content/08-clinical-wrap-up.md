...
One family interferes with DNA synthesis. Fluorouracil, methotrexate, irinotecan and doxorubicin all act on the gut by interrupting DNA synthesis, which is to say they act on S phase.

The other family interferes with the spindle. Antimicrotubule drugs, including vinblastine, vincristine, colchicine and paclitaxel, inhibit microtubule dynamics. The consequence is a failure to align the chromosomes at the metaphase plate, and that failure activates the spindle assembly checkpoint. Scene four's machinery is the target: the drug works by making sure the checkpoint's condition is never satisfied.

A drug aimed at S phase or at M phase can only affect a cell that is in S phase or M phase. So the question of which tissues suffer becomes a question about what fraction of each tissue's cells are in those phases at any moment.
