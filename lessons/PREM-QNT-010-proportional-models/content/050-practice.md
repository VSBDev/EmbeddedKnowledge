...
Record an answer and method for all four prompts before opening the final feedback scene. Then compare your method, not only your final number.
...
Use these prompts only after a first attempt:
...
All practice prompts and recovery guidance are original.
:::
