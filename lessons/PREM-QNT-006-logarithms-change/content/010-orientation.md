...
The equality threshold is $t=\log_2 40\approx5.32$. In the continuous model, the value exceeds 10,000 when $t>5.32$. If only completed cycles count, the first exceeding cycle is 6 because $250(2^5)=8000$ and $250(2^6)=16000$.
